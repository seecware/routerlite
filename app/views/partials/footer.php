<footer class="bg-gray-100 border-t border-gray-200 border-dashed text-sm text-gray-600 mt-8">
  <div class="max-w-7xl mx-auto px-4 py-6">
    <div class="flex flex-wrap justify-center gap-x-4 gap-y-2 text-center md:justify-start md:text-left">
      <a href="#" class="hover:underline">Español (México)</a>
    ...
    <div class="mt-6 text-center text-xs text-gray-400">
      &copy; <?= date('Y') ?> Seecware. All rights reserved.
    </div>
  </div>
</footer>
